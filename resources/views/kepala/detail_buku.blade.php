...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <h2>Detail Buku</h2>
    <a href="{{ route('kepala.books.index') }}" style="background-color: #888; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">← Kembali</a>
</div>
    ...
    <div style="display: grid; grid-template-columns: 250px 1fr; gap: 30px;">
        ...
        <div>
            ...
            <div style="display: flex; gap: 10px; padding-top: 20px; border-top: 1px solid #eee;">
                <a href="{{ route('kepala.books.index') }}" style="background-color: #888; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-flex; align-items: center; gap: 8px;">
                    ← Kembali
                </a>
            </div>
        </div>
