    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            @if($role === 'anggota')
                ...
                <a href="{{ route('anggota.books.index') }}" class="{{ request()->routeIs('anggota.books.*') ? 'active' : '' }}">Koleksi Buku</a>
                <a href="{{ route('anggota.borrow.index') }}" class="{{ request()->routeIs('anggota.borrow.*') ? 'active' : '' }}">Peminjaman</a>
                <a href="{{ route('anggota.returns.index') }}" class="{{ request()->routeIs('anggota.returns.*') ? 'active' : '' }}">Pengembalian</a>
            @elseif($role === 'petugas')
                <a href="{{ route('petugas.dashboard') }}" class="{{ request()->routeIs('petugas.dashboard') ? 'active' : '' }}">Dashboard</a>
                <a href="{{ route('petugas.books.index') }}" class="{{ request()->routeIs('petugas.books.*') ? 'active' : '' }}">Koleksi Buku</a>
                <a href="{{ route('petugas.categories.index') }}" class="{{ request()->routeIs('petugas.categories.*') ? 'active' : '' }}">Kategori</a>
                <a href="{{ route('petugas.borrow.index') }}" class="{{ request()->routeIs('petugas.borrow.*') ? 'active' : '' }}">Peminjaman</a>
                <a href="{{ route('petugas.returns.index') }}" class="{{ request()->routeIs('petugas.returns.*') ? 'active' : '' }}">Pengembalian</a>
                <a href="{{ route('petugas.members.index') }}" class="{{ request()->routeIs('petugas.members.*') ? 'active' : '' }}">Data Anggota</a>
